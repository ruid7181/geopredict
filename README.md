...
The site also includes a prominent 18-second workflow explainer film, three engine-responsive Seattle diagnostics (distribution, spatial-fold error and confidence profile), and published benchmark figures reproduced from the peer-reviewed GeoAggregator and TabPFN-GSA studies. Published evidence and interface-preview values are labelled separately.
