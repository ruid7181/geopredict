...
The site also includes an interactive six-stage workflow animation, three engine-responsive Seattle diagnostics (distribution, spatial-fold error and confidence profile), and published benchmark figures reproduced from the peer-reviewed GeoAggregator and TabPFN-GSA studies. Published evidence and interface-preview values are labelled separately.
